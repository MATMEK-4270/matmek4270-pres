...
where $u(x, t)$ is the solution and $c$ is the constant wavespeed.
...
## If you do not have analytic $I(x)$, then what? {.smaller}
...
## For $|A| = 1$ and stability we need $-2 \le \beta \le 2$ and thus {.smaller}
