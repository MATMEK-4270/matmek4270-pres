...
$$
\sum_{k=0}^N \int_{-1}^1 P_k(X)  P_j(X)\, \cancel{\frac{dx}{dX}} \, dX \, \hat{u}_k =  \int_{-1}^1 u(x(X)) P_j(X) \, \cancel{\frac{dx}{dX}} \, dX, \quad j=0, 1, \ldots, N
$$
...
$$
\sum_{k=0}^N \int_{-1}^1 P_k(X)  P_j(X) \, dX \, \hat{u}_k =  \int_{-1}^1 u(x(X)) P_j(X) \, dX, \quad j=0, 1, \ldots, N
$$
