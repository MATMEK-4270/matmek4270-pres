...
A **basis** is a collection (set) of basis functions
...
## We can choose any points, and any number of basis functions {.smaller}
...
```
which is very small because the Lagrange interpolator happens to be close to exact for all the midpoints for this function. It is not zero in general.
