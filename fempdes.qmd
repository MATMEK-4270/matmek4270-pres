...
* We always use reference elements (triangles, tetrahedra)
...
* It is very common to use integration by parts or Green's first identity in order to manipulate the variational equation and to incorporate **natural** Neumann boundary conditions.
